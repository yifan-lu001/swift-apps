...
public struct PieChartViewHome: View {
    public let values: [Double]
    public let names: [String]
    public let formatter: (Double) -> String
...
struct PieChartView_Previews: PreviewProvider {
    static var previews: some View {
        PieChartView(values: [1300, 500, 300, 100], names: ["Rent", "Transport", "Education", "Hello"], formatter: {value in String(format: "$%.2f", value)}, colors: [.blue, .green, .red, .orange])
    }
}
